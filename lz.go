...
// reader. The sequencers are provided here seperately because they are more
...
//
// We provide also two decoders. The Decoder slides the decompression window
// through a larger buffer implmented by Buffer. The RingDecoder uses the
// RingBuffer that requires only a slice of the size of the window plus 1. The
// Decoder is significantly faster.
package lz
